...
<head>
	...
	<meta name="description" content="问卷排名">
	<meta name="keywords" content="问卷排名" />
...
<body>
					...
					<div class="row">
						<div class="col-xs-10 col-md-5">
							<h4 style="margin-top: 0px; margin-bottom: 0px;">
								<strong>问卷排行榜  -  ${surveyname}</strong>
	...
	<script type="text/javascript" src="/static/js/system/admin/TopChartSurvey.js"></script>
</body>
</html>