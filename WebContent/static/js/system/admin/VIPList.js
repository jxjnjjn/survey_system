...
$("#searchvipbtn").on('click',function(){
	var username = $("#vip_name")[0].value;
	if( username == "")
	{
		getData(1);
	}
	...
	{
		getVIPInfoByName(username);
	}
	//getVIPInfoByName($("#vip_name")[0].value);
});

function getVIPInfoByName(username){
	$.ajax({
		type : "GET",
		url : "/system/vip/getlistbyname",
		dataType : "JSON",
