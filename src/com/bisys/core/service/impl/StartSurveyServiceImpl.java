...
//				   "[选择题]".equals(question.substring(0, question.indexOf("]")+1))||
//				   "[选择]".equals(question.substring(0, question.indexOf("]")+1))||
//				   "[单选]".equals(question.substring(0, question.indexOf("]")+1))
//						){
//					radio_num++;
...
//					Stemp.append("<h4><strong>"+ls[1]+"</strong></h4>");
//					
...
//						"[填空]".equals(question.substring(0, question.indexOf("]")+1))
//						){
//					String[] ls = question.split("<br />\r\n");
//					fillinblank_num++;
...
//					Stemp.append("<h4><strong>"+ls[1]+"</strong></h4>");
//					Stemp.append("<input type=\"text\" name=\""+ fillinblank_name  +"\" class=\"form-control input-lg\" placeholder=\"请输入\">");
//					Stemp.append("</div>");
//				}else{
//					logger.info("[未知]");
