...
import com.bisys.core.exception.DaoException;
...
public class GeneralDaoImpl implements GeneralDao {
	...
	private boolean updateEntityString (Class<?> clazz, String tableName, String primaryKey, Object entity, String ... updateFields) throws Exception{
		...
		try{
			...
			logger.info("returnFlag updateEntityString :" + returnFlag+",sql:"+sqlBuilder.toString());
		}catch(DataAccessException e){
	...
	private boolean addOrUpdate(String sql, Object... obj){
		try {
			...
			logger.info("returnFlag打印输出：" + returnFlag + ",sql:" + sql);
		} catch (Exception e) {
